...
class Custom(_Scale):
    ...
    def buildFn(self, pos, key):
            ...
            return {
                ...
                "fourthPerfect": intervals.perfect_fourth(p[1]),
                "fifth": intervals.fifth(p[1], key),
                "fifthMinor": intervals.minor_fifth(p[1]),
                "fifthMajor": intervals.major_fifth(p[1]),
                "fifthPerfect": intervals.perfect_fifth(p[1]),
                "sixth": intervals.sixth(p[1], key),
                "sixthMinor": intervals.minor_sixth(p[1]),
